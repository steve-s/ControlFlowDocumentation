...
\chapter{Analysing PHP Code}
    ...
    The following \wsection{} \nameref{phpsem} describes some important parts 
    of the semantics of the PHP programming language, especially those 
    that represent a challenge for static analysis.

    \wSection{} \nameref{statanal} gives a brief overview of existing 
...
\end{Verbatim}
    ...
    \label{statanal}
        ...
        flow due to conditionals, \code{goto} statements or any 
