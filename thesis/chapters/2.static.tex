...
\chapter{Analysing PHP Code}
    ...
    The following \wsection{} PHP Semantics describes some important parts 
    of the semantics of the PHP programming language, especially those 
    that represent a challenge for static analysis.

    \wSection{} Static Code Analysis gives a brief overview of existing 
    ...
    context for the following \wsection{} Control Flow for Phalanger Approach, 
...
\end{figure}
    ...
    \label{phalapproach}
        ...
        The remaining questions that have to be answered, in order to 
...
%pygmentize_end
        ...
        For instance, if function \code{boo} 
        ...
        and merge with type \code{T}, creating an over-approximation.
